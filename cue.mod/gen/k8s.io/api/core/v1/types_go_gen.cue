...
#ResourceFieldSelector: {
	// Container name: required for volumes, optional for env common
	// +optional
...
// PodInitialized means that all init_controller containers in the pod have started successfully.
...
#PodSpec: {
	...
	// init_controller container fails, the pod is considered to have failed and is handled according
	// to its restartPolicy. The name for an init_controller container or normal container must be
	// unique among all containers.
	// Init containers may not have Lifecycle actions, Readiness probes, Liveness probes, or Startup probes.
	// The resourceRequirements of an init_controller container are taken into account during scheduling
	// by finding the highest request/limit for each resource type, and then using the max of
	// of that value or the sum of the normal containers. Limits are applied to init_controller containers
...
#EphemeralContainerCommon: {
	...
	// This name must be unique among all containers, init_controller containers and ephemeral containers.
	name: string @go(Name) @protobuf(1,bytes,opt)
...
#PodStatus: {
	...
	// The list has one entry per init_controller container in the manifest. The most recent successful
	// init_controller container will have ready = true, the most recently started container will have
	// startTime set.
